...
function openEpaycoCheckout(data) {
    ...
    const checkoutData = {
        ...
        external: 'false',
        response: 'https://supplements-releases-learning-jeff.trycloudflare.com/payment/response',
        confirmation: 'https://supplements-releases-learning-jeff.trycloudflare.com/payment/confirmation',
