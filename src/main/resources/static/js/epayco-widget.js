...
function openEpaycoCheckout(data) {
    ...
    const checkoutData = {
        ...
        external: 'false',
        response: 'https://holidays-dolls-pumps-und.trycloudflare.com/payment/response',
        confirmation: 'https://holidays-dolls-pumps-und.trycloudflare.com/payment/confirmation',
