            ...
            modalContent.innerHTML = `
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-2">
                            <strong>Monto:</strong> 
                            <span class="text-success">${payment.currency} ${formatNumber(payment.amount)}</span>
                        </div>
                        <div class="mb-2">
...
function getStatusBadge(status) {
    const badges = {
        'ACCEPTED': '<span class="badge bg-success"><i class="fas fa-check-circle me-1"></i>Aceptado</span>',
        'PENDING': '<span class="badge bg-warning text-dark"><i class="fas fa-clock me-1"></i>Pendiente</span>',
        'REJECTED': '<span class="badge bg-danger"><i class="fas fa-times-circle me-1"></i>Rechazado</span>',
        'FAILED': '<span class="badge bg-secondary"><i class="fas fa-exclamation-circle me-1"></i>Fallido</span>'
    };
